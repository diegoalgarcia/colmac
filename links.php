...
<html lang="zxx">
   ...
   <head>
      ...
      <!--Page Title-->
      <title>Colegio Miguel Antonio Caro</title>
                     ...
                     <div class="col-lg-9 d-none d-lg-block d-md-none">
                        <nav class="navbar navbar-expand-lg justify-content-left">
                           <ul class="navbar-nav">
                              ...
                              <li class="dropdown active"><a class="nav-link" href="#">Pages</a>
                                 <ul class="dropdown-menu">
            ...
            <div class="row h-100">
               <div class="col-lg-12 my-auto">
                  <div class="page-banner-content text-center">
                     <h2 class="page-banner-title">Notice Board</h2>
						...
						<table class="table table-hover">
							...
							<tbody class="mt-3">
								<tr>
									...
									<td>
										<p><a href="#">Pellentesque Sed ut perspiciatis unde omnis iste natus error sitre voluptatem </a></p>
									</td>
									<td>
										<p>12/31/2021</p>
									</td>
