            ...
            <div class="row h-100">
               <div class="col-lg-12 my-auto">
                  <div class="page-banner-content text-center">
                     <h2 class="page-banner-title">Estudiantes grado Decimo</h2>
            ...
            <div class="row">
               <div class="col-lg-10 col-md-10 col-12 mx-auto">
                  <div class="faq-lis-heading text-center">
                     <h2>Formulario de Registro grado Decimo para Estudiantes</h2>
                  </div>
                  <div class="faq-contact-form-wrap shadow bg-white">
                     <form class="faq-contact-form contact-form"  action="ingresa_decimo.php" method="POST">
                        <div class="row">
                           <div class="col-md-6">
